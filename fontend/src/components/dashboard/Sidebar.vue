...
.sub-menubar-hide{
    height: 0px !important;
          ...
          >
            ...
            >
              <li
                :class="menu.isActive === true ? 'd-block' : 'd-none'"
                class="nav-item"
  ...
  data() {
    return {
      listMenu: [
        {
          mainMenu: "Home",
          icon: "nav-icon fas fa-solid fa-house-user",
          permission: "",
          isActive: false,
          subMenu: [
            {
        ...
        {
          mainMenu: "Master",
          icon: "nav-icon fas fa-solid fa-dumpster",
          permission: "",
          isActive: false,
          subMenu: [
            {
